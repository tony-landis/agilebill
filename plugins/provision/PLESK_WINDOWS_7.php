...
if(empty($VAR))
{
    ...
    $plg = new plgn_prov_PLESK_WINDOWS_7();
    $plg->p_all($VAR);
}


# Main Class
class plgn_prov_PLESK_WINDOWS_7
{
    function plgn_prov_PLESK_WINDOWS_7()
    {
        $this->name             = 'PLESK_WINDOWS_7';
    ...
    function p_new()
    {
        ...
        $cmd =  "client.exe" .
			...
			" -pcode \"".           $this->account['zip'] . "\"" .
            " -notify \"true\"" .
        $this->nl;

        # Set the account options
        $cmd .= "client_pref.exe -u ".$this->account['username'].
