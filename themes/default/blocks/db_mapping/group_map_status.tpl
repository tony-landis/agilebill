...
<table width="100%" border="0" cellspacing="3" cellpadding="1" class="row1">
  <tr valign="top">
    <td width="34%" height="20"><b>Local Group</b></td>
    <td width="34%" height="20"><b>Mapped To Group</b></td>
    <td width="32%" height="20"><b>Authentication Rank</b></td>
  </tr> 
  ...
  <tr valign="top"> 
    ...
    <td width="34%" height="20"> 
      <input type="text" name="db_mapping_group_map[{$db_mapping_groups_local.id}]"  value="{$db_mapping_groups_local.value}" size="12">
    </td>
