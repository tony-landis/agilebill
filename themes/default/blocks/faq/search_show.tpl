          ...
          <table id="main2" width="100%" border="0" cellspacing="1" cellpadding="2">
            ...
            <tr valign="middle" align="center" class="table_heading"> 
              ...
              <td width="388" class="table_heading"> 
                {literal}
                <script language="JavaScript">
					document.write(search_heading('{/literal}{translate module=faq}field_name{/translate}{literal}','name'));
				 </script>
                {/literal}
              </td>
              <td width="508" class="table_heading"> 
                {literal}
                <script language="JavaScript">
					document.write(search_heading('{/literal}{translate module=faq}field_faq_category_id{/translate}{literal}','faq_category_id'));
				 </script>
                {/literal}
              </td>
            ...
            <tr id="row{$record.id}" onClick="row_sel('{$record.id}',1);" onDblClick="window.location='?_page=faq:view&id={$record.id},{$COOKIE_URL}';" onMouseOver="row_mouseover('{$record.id}', 'row_mouse_over_select', 'row_mouse_over');" onMouseOut="row_mouseout('{$record.id}', '{$record._C}', 'row_select');" class="{$record._C}"> 
