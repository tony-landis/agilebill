...
{$method->exe("newsletter","search_show")}
      ...
      <td>
          <table id="main2" width="100%" border="0" cellspacing="1" cellpadding="2">
            ...
            <tr valign="middle" align="center" class="table_heading"> 
              <td width="7%" class="table_heading">&nbsp;</td>
              <td width="59%" class="table_heading"> 
                {literal}
                <script language="JavaScript">
					document.write(search_heading('{/literal}{translate module=newsletter}field_name{/translate}{literal}','name'));
				 </script>
                {/literal}
              </td>
              <td width="27%" class="table_heading"> 
                {literal}
                <script language="JavaScript">
					document.write(search_heading('{/literal}{translate module=newsletter}field_display_signup{/translate}{literal}','display_signup'));
				 </script>
                {/literal}
              </td>
              <td width="7%" class="table_heading">&nbsp; </td>
            ...
            <tr id="row{$record.id}" onClick="row_sel('{$record.id}',1);" onDblClick="window.location='?_page=newsletter:view&id={$record.id},';" onMouseOver="row_mouseover('{$record.id}', 'row_mouse_over_select', 'row_mouse_over');" onMouseOut="row_mouseout('{$record.id}', '{$record._C}', 'row_select');" class="{$record._C}"> 
