...
{ $method->exe("task","search_form") }
{ if ($method->result == FALSE) }
    { $block->display("core:method_error") }
{else}

<form name="task_search" method="post" action="">
            ...
            <table width="100%" border="0" cellspacing="3" cellpadding="1" class="row1">
                   <tr valign="top">
                    <td width="35%">
                        ...
                        {/translate}</td>
                    <td width="65%">
                        { $list->calender_search("task_date_start", $VAR.task_date_start, "form_field", "") }
                    </td>
                  </tr>
                   <tr valign="top">
                    <td width="35%">
                        ...
                        {/translate}</td>
                    <td width="65%">
                        { $list->calender_search("task_date_expire", $VAR.task_date_expire, "form_field", "") }
                    </td>
                  </tr>
                   <tr valign="top">
                    <td width="35%">
