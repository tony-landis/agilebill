          ...
          <td width="65%" class="row1">
            <table width="100%" border="0" cellspacing="3" cellpadding="1" class="row1">
                <tr valign="top">
                    <td width="35%">
                        ...
                        {/translate}</td>
                    <td width="65%">
                        {html_menu field=voip_blacklist_voip_did_id assoc_table=voip_did assoc_field=did conditions="account_id = `$smarty.const.SESS_ACCOUNT`" }
                    </td>
                </tr>
                <tr valign="top">
                    <td width="35%">
           ...
           <tr valign="top">
                    ...
                    <td width="65%">
                      ...
                      <input type="hidden" name="_page_current" value="voip_blacklist:user_add">
                      <input type="hidden" name="do[]" value="voip_blacklist:user_add">
                    </td>
                </tr>
              </table>
            </td>
